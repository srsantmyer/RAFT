...
public class WebDriverFactory {
	...
	public static WebDriver getWebDriver(Browser browser) {
		...
		var isHeadless = Boolean.parseBoolean(System.getProperty("isHeadless", "false"));

		if(isHeadless && browser == Browser.CHROME){
		...
		switch (browser) {
			...
			case CHROME_HEADLESS:
				...
				List<String> list = Stream.of("headless", "--incognito").collect(Collectors.toList());
				chromeOptionsHeadless.addArguments(list);
	...
	public static WebDriver getRemoteWebDriver(Browser browser, String browserVersion, Platform platform,
			String recordVideo, String timeZone, String screenResolution, String remoteUrl) {
		...
		if (StringUtils.isNotEmpty(recordVideo)) {
			desiredCapabilities.setCapability("se:recordVideo", Boolean.parseBoolean(recordVideo));
		}

		if (StringUtils.isNotEmpty(timeZone)) {
			desiredCapabilities.setCapability("se:timeZone", timeZone);
		}

		if (StringUtils.isNotEmpty(screenResolution)) {
			desiredCapabilities.setCapability("se:screenResolution", screenResolution);
		}
	...
	public static WebDriver getRemoteWebDriver(Browser browser, String remoteUrl) {
		return getRemoteWebDriver(browser, null, null, null, null, null, remoteUrl);
	}
